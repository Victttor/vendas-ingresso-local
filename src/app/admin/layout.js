...
import { ChevronDownIcon, FolderPlusIcon, ListBulletIcon, MagnifyingGlassIcon } from '@heroicons/react/20/solid'
...
const _navigation = [
  ...
  { name: 'Eventos', href: '/admin/eventos', icon: CalendarIcon, current: false },
  { name: 'Ingressos', href: '/admin/ingressos', icon: TicketIcon, current: false },
  { name: 'Categoria Ingressos', href: '/admin/categ_ingressos', icon: SquaresPlusIcon, current: false },
  { name: 'Lote Ingressos', href: '/admin/lote_ingressos', icon: FolderPlusIcon, current: false },
  { name: 'Log de Vendas', href: '/admin/log_vendas', icon: DocumentIcon, current: false },
]
